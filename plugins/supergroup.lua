...
pm = pm..'\n <code>➣</code> <b>Lock</b> <code>➣</code> <b>Username</b> <code>»</code> '..group[tostring(target)]['settings']['lock_username']..''
