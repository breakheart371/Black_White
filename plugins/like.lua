local function run(msg, matches)
	local like = function(arg, data)
	 ...
	 tdcli_function({ID = "GetInlineQueryResults",bot_user_id_ = 316813335,chat_id_ = msg.chat_id_,user_location_ = {ID = "Location",latitude_ = 0,longitude_ = 0},query_ = matches[2],offset_ = 0}, like, nil)
end
return {
  patterns = {
    "^[#!/](like) (.*)$"
...
--https://github.com/babakkhan375/Black_White
